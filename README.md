...
* **[Mr. Robot's Netflix 'n' Hack](https://github.com/AnarchoTechNYC/meta/wiki/Mr.-Robot%27s-Netflix-%27n%27-Hack?fbclid=IwAR0mCRMywMVLg2qmoK0OSGC7uUqhvuhNMkXGNpATk3H_VcdO4mIyox5zMRQ)**
...
* **[deksterecon](https://github.com/0xdekster/deksterecon)** : a Web Application recon automation , it aggregates your target results at one place so that the struggle of manually running each tool on single target/url will get removed and it helps to get a broader view of your attack surface.
...
* **[WPScan](https://github.com/wpscanteam/wpscan)** : a WordPress security scanner written for security professionals and blog maintainers to test the security of their WordPress websites.
...
* **[Forensically](https://29a.ch/photo-forensics/)** : a set of free tools for digital image forensics. It includes clone detection, error level analysis, meta data extraction and more.
...
* **[StegCracker](https://github.com/Paradoxis/StegCracker)** : a Steganography brute-force utility to uncover hidden data inside files.
...
* **[enum4linux](https://gitlab.com/kalilinux/packages/enum4linux)** : a Linux alternative to enum.exe for enumerating data from Windows and Samba hosts.
...
### Others
* **[quack](https://github.com/entynetproject/quack)** : a set of tools to provide denial of service attacks; SMS attack tool, HTTP attack tool and many other attack tools.

* **[GSMEVIL 2](https://github.com/sharyer/gsmevil2)** : a python web based tool which use for capturing imsi numbers and sms and also you able to see sms and imsi on any device using your favorite browser and it's make easy to capture sms and imsi numbers for those who not have much knowledge about gsm packets capturing.
...
* [braincoke](https://braincoke.fr/write-up)
* [dominicbreuker](https://dominicbreuker.com/)
